...
public class EspecialidadController {
	...
	public ResponseEntity<EspecialidadDTO> listarPorId(@PathVariable("id") Integer id) throws Exception{
		...
		Especialidad obj = service.listarPorId(id); //Especialidad		

		if(obj == null) {
			throw new ModeloNotFoundException("ID NO ENCONTRADO " + id);
		}else {
			dtoResponse = mapper.map(obj, EspecialidadDTO.class); //EspecialidadDTO
		}
	...
	@PutMapping
	public ResponseEntity<EspecialidadDTO> modificar(@RequestBody EspecialidadDTO dtoRequest) throws Exception {

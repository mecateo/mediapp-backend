...
public class ExamenController {
	...
	public ResponseEntity<ExamenDTO> listarPorId(@PathVariable("id") Integer id) throws Exception{
		...
		Examen obj = service.listarPorId(id); //Examen		

		if(obj == null) {
			throw new ModeloNotFoundException("ID NO ENCONTRADO " + id);
		}else {
			dtoResponse = mapper.map(obj, ExamenDTO.class); //ExamenDTO
		}
	...
	@PutMapping
	public ResponseEntity<ExamenDTO> modificar(@RequestBody ExamenDTO dtoRequest) throws Exception {

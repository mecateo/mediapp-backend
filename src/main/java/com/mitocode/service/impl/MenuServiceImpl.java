...
public class MenuServiceImpl extends CRUDImpl<Menu, Integer> implements IMenuService{
	...
	@Override
	@Transactional
	public Integer grabarMenuRol(Integer idMenu, Integer idRol) {
		return repo.registrarMenuRol(idMenu, idRol);
	}

	@Override
	@Transactional
	public Integer quitarMenuRol(Integer idMenu, Integer idRol) {
		return repo.quitarMenuRol(idMenu, idRol);
	}
